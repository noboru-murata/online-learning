...
\begin{frame}[label={sec:org3cfd96c}]{Characteristics}
\begin{itemize}
\item batch learning:
\begin{description}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org309a143}]{}
\centering
...
\begin{frame}[label={sec:org8ccb30f}]{}
\centering
...
\begin{lemma}[Akahira \& Takeuchi, 1981; Bottou \& Le Cun, 2005]\label{sec:orgb06995b}
...
\begin{frame}[label={sec:org0d69eb6}]{Optimal On-line Learning}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org864bd68}]{}
\centering
...
\begin{frame}[label={sec:org421bc30}]{Optimal Design of \(\varPhi_{t}=C/t\)}
\begin{itemize}
...
\begin{frame}[label={sec:orgef182b6}]{Equivalence to Batch Learning}
\begin{itemize}
\item on-line learning: 
\begin{align}
...
\begin{frame}[label={sec:orgab1f6d8}]{}
\centering
...
\label{sec:org4ad9385}
\begin{frame}[label={sec:org221cefa}]{Problem of Semi-Optimal Update}
\begin{itemize}
...
\begin{frame}[label={sec:org79c935f}]{Description of Restrictions}
\begin{itemize}
...
\begin{frame}[label={sec:org194197e}]{Description of Restrictions}
\begin{itemize}
...
\begin{frame}[label={sec:org4b2e2d8}]{Problem Formulation}
...
\section{Conclusion}
\label{sec:orgf1fc03f}
\begin{frame}[label={sec:org4ffe3df}]{Concluding Remarks}
